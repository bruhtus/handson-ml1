...
def main():
    ...
    # print(
    #     f'Without scaler: {cross_val_score(sgd_clf, X_train, y_train, cv=3, scoring="accuracy")}'
    # )
    # print(
    #     f'With scaler: {cross_val_score(sgd_clf, X_train_scaled, y_train, cv=3, scoring="accuracy")}'
    # )

    # y_train_pred_scaled = cross_val_predict(sgd_clf,
    #                                         X_train_scaled,
    #                                         y_train,
    #                                         cv=3)
    ...
    #     axis=1, keepdims=True)  #keepdims to keep dimensions of the array
    # norm_conf_mx = conf_mx / row_sums
    # np.fill_diagonal(norm_conf_mx,
    #                  0)  #fill diagonal with 0s, keep only the errors
    ...
    # print(
    #     f'KNN f1-score: {f1_score(y_train, y_train_knn_pred, average="macro")}'
    # )
